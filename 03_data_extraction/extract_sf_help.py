...
pele_mean_file = "The pele containing the mean PELE BE score to use for all systems"
...
common_systems_list = "When this option is selected the program will generate a file containing the list " \
                                "of the systems for which all the scoring functions and all descriptors were correctly " \
                                "computed. The name will be output_general_name+_common_systems.csv"
