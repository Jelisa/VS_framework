...
structure_selection_output_prefix_desc = "The prefix to use for the output files containing the metrics " \
                                         "from the report one for the initial model and another for the" \
                                         "selected_model. The names are (prefix_)initial_models_pele_metrics.csv " \
                                         "and (prefix_)selected_models_pele_metrics.csv"
...
ss_total_energy_deviation_desc = "The maximum desviation in KCal of the minimum total PELE energy possible" \
                               "this criteria is always present and is combined with any selection criteria." \
                               "With this we avoid picking unfeasible systems from the non-converged part of the " \
                               "simulation or the artifacts that the adaptive protocol may create."
