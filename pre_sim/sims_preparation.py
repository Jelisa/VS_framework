...
def create_template_and_rotamerlib(initial_pdb, template_folder, rotamer_library_folder):
    ligand_filename_mae = initial_pdb.split(".pdb")[0] + ".mae"
    ...
    try:
        ploprottemp_output = check_output(command2call2.split(), stderr=STDOUT)
    except CalledProcessError as error_message:
            ...
            with open(name4file, 'r') as filein:
                ...
                if number_of_lines <= 1:
                    ...
                    logging.info("The library of rotamers has been correctly generated and is: {}".format(
                        destination_file))
                    os.rename(name4file, destination_file)
...
parser.add_argument("-pele_folders", default="/home/jelisa/workspace/PELE-1.5/",
...
parser.add_argument("-plop_path", default="/home/jelisa/PhD_work/VS/working_plop/PlopRotTermp.py",
                    help=help_descriptions.plop_path_desc)
parser.add_argument("-conf_template", "-conf_file_template", default="./template.conf",
                    help=help_descriptions.template_desc)
parser.add_argument("-pele_license", default="/gpfs/projects/bsc72/PELE++/license",
